...
public abstract class BACnetObjectBridgeHandler<T extends BACnetObject, B extends BACnetNetworkBridgeHandler<?>, C extends BACnetConfig>
  extends BasePollingBridgeHandler<C> {

  public BACnetObjectBridgeHandler(Bridge bridge) {
    super(bridge);
  }
