...
public class WeekScheduleItem extends GenericItem implements Item {

  public WeekScheduleItem(String itemName) {
    super(TemporalItemFactory.WEEK_SCHEDULE, itemName);
  }
