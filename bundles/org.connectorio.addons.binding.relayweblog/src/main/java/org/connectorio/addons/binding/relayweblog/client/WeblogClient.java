...
public class WeblogClient {
  ...
  public WeblogClient(String uri, String password) {
    this(ClientBuilder.newBuilder(), uri, password);
  }

  public WeblogClient(ClientBuilder clientBuilder, String uri, String password) {
  ...
  private void login(String passwordHash, SigningContext signingContext) {
  ...
  public static void main(String[] args) {
    ...
    WeblogClient client = new WeblogClient("http://localhost:18080", password);
