 ...
 */
package org.connectorio.addons.binding.mbus;
...
public interface MBusBindingConstants extends BaseBindingConstants {

  String BINDING_ID = BaseBindingConstants.identifier("mbus");
