...
public class ChainedDiscoveryCoordinator implements DiscoveryCoordinator {
  ...
  @Override
  public DiscoveryResult discover(ThingUID bridgeUID, long timeToLive, VariableDataStructure message) {
  ...
  @Reference
  void addDiscoveryParticipant(MBusDiscoveryParticipant participant, Map<String, Object> props) {
    int ranking = determineServiceRanking(props);
    discoveryEntries.add(new DiscovererEntry(ranking, participant));
  }

  void removeDiscoveryParticipant(MBusDiscoveryParticipant participant, Map<String, Object> props) {
    int ranking = determineServiceRanking(props);
  ...
  static class DiscovererEntry {
    final int ranking;
    final MBusDiscoveryParticipant participant;

    DiscovererEntry(int ranking, MBusDiscoveryParticipant participant) {
    ...
    public MBusDiscoveryParticipant getParticipant() {
      return participant;
    }
